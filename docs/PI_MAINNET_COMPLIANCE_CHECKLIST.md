# PI MAINNET COMPLIANCE CHECKLIST
...
- [ ] Domain: https://lynkapp.com / https://app.lynkapp.com
- [ ] Developer KYC status recorded before submission
- [ ] Wallet Mainnet migration status recorded before submission
- [ ] Pi Auth only check for the Pi Browser deployment
- [ ] Pi Payment only check for the Pi Browser deployment
- [ ] No trademark violation check
- [ ] No external redirection check
- [ ] Minimal data collection check
- [ ] Privacy policy link
- [ ] Terms link
- [ ] Delete account support
- [ ] Report/block support
- [ ] Professional UI checklist
- [ ] First Mainnet payment test checklist
- [ ] Incomplete payment recovery checklist
- [ ] Branding check: no “Lynk Pi”, no “Lynk Global”, no public channel labels
